					...
					<div class="shop_content">
						...
						<div class="product_grid row">
							...
							<div class="product_item is_new">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($pro->image_one)}}" alt="" style="height: 100pex; width: 100px;"></div>
