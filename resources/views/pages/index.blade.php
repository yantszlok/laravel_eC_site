...
@php
 ...
 $trend = DB::table('products')->where('trend',1)->orderby('id','desc')->limit(8)->get();
 
 $best = DB::table('products')->where('best_rated',1)->orderby('id','desc')->limit(8)->get();
    ...
    <div class="owl-item deals_item">
        ...
        <div class="deals_content">
            ...
            <div class="deals_info_line d-flex flex-row justify-content-start">
                ...
                <div class="deals_item_price ml-auto">{{ $ht->product_name }}</div>
            </div>
            <div class="available">
                        ...
                        <div class="col-lg-9">
                            <div class="trends_slider_container">
                                ...
                                <div class="owl-carousel owl-theme trends_slider">
                                    ...
                                    @foreach($buyonegetone as $row)
                                    <div class="owl-item">
                                        <div class="trends_item is_new">
                                            <div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($row->image_one)}}" alt="" style="height: 120px; width:100px"></div>
...
@endphp
                        <div class="owl-carousel owl-theme brands_slider">
                            ...
                            <div class="owl-item"><div class="brands_item d-flex flex-column justify-content-center"><img src="{{ asset($row->brand_logo)}}" alt="" style="height:70px; width:70px;"></div></div>
                            @endforeach
                        </div>
