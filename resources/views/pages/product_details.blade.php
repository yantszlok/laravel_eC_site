			...
			<form action="{{url('cart/product/add/'.$product->id)}}" method="post">
                @csrf
                        ...
                        <div class="form-group">
                            <label for="exampleFromControlSelect">Color</label>
                            <select class="form-control input-lg" id="exampleFromControlSelect" name="color">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control input-lg" id="exampleFromControlSelect" name="size">
